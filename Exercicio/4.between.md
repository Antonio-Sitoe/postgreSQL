...
4. [x] **Clientes cadastrados entre 2019 e 2021 (se houvesse `data_cadastro` — não temos; demonstrativo).**

5. [x] **Lançamentos ocorridos no último trimestre (exemplo dinâmico).**
